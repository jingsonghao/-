<template>
  <div>
    ...
    <ipt-edit id="js_edit_modal" :storeId="storeId" :params="params"></ipt-edit>
    <div class="shadow-boxs">
      <div class="col-lg-12">
        <!-- [表格] -->
        ...
        <ipt-table
          ...
          <td slot="afterBody" slot-scope="scope">
            ...
            <a href="javascript:;" class="edit-link" data-toggle="modal" data-target="#js_edit_modal"
               @click="storeId = scope.columnData.storeId"
    ...
    methods: {
      ...
      approvalBtn(columnData) {
        this.$confirm('是否审核通过?', '提示', {
          ...
          Api.StoreRecord.approval(columnData.storeId).then((data) => {
            this.$message({
              type: 'success',
              message: '审核成功!'
            })
