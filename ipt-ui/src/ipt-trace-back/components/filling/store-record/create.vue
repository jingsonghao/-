        ...
        <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="text" v-model="storeRecord.storeName" name="storeName" class="form-control"
                   v-validate="'required'" :class="{'is-danger': errors.has('storeName') }">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="text" v-model="storeRecord.storeNo" name="storeNo" class="form-control"
                   v-validate="'required'" :class="{'is-danger': errors.has('storeNo') }">
    ...
    methods: {
      create () {
        ...
        that.$validator.validateAll().then((result) => {
          if (result) {
            Api.StoreRecord.create(that.storeRecord).then((data) => {
