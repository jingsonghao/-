<template>
  <div>
    ...
    <ipt-edit id="js_edit_modal" :businessBaseInfoId="businessBaseInfoId" :params="params"></ipt-edit>
    <div class="shadow-boxs">
      <div class="col-lg-12">
        <!-- [表格] -->
        ...
        <ipt-table
          ...
          <td slot="afterBody" slot-scope="scope">
            ...
            <a href="javascript:;" class="edit-link" data-toggle="modal" data-target="#js_edit_modal"
               @click="businessBaseInfoId = scope.columnData.businessBaseInfoId"
    ...
    methods: {
      ...
      approvalBtn(columnData) {
        this.$confirm('是否审核通过?', '提示', {
          ...
          Api.BusinessesRecord.approval(columnData.businessBaseInfoId).then((data) => {
            this.$message({
              type: 'success',
              message: '审核成功!'
            })
      ...
      deleteBtn(columnData) {
        this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
          ...
          Api.BusinessesRecord.deleteOne(columnData.businessBaseInfoId).then((data) => {
            this.$message({
              type: 'success',
              message: '删除成功!'
            })
