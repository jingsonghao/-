    ...
    <template slot="modalBody">
      <form class="form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-7">
            <el-select v-model="nodeRecord.enterpriseTypeEnum.value" name="enterpriseType" filterable placeholder="请选择"
        ...
        <div class="form-group">
          ...
          <div class="col-sm-7">
            <el-select v-model="nodeRecord.legalTypeEnum.value" name="legalType" filterable placeholder="请选择"
