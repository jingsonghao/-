    ...
    <template slot="modalBody">
      <form class="form-horizontal">
        ...
        <div class="summernote">
          ...
          <vue-editor id="plan-add-editor" v-model="editedParams.remark" useCustomImageHandler @imageAdded="handleImageAdded"></vue-editor>
        </div>
      </form>
    </template>
    ...
    methods: {
      saveAdd: function () {
        ...
        self.$validator.validateAll().then((result) => {
          if (result) {
            Api.EmergencyPlan.create(this.editedParams).then((data) => {
