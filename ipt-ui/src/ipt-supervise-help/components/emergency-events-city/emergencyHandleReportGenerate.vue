      ...
      <div class="col-xs-12">
        ...
        <div class="report-content">
          <form class="form-horizontal">
            ...
            <div class="form-group">
              <label class="label-title">应急报告发送人</label><div class="col-sm-8">{{singleData.currentUserName}}</div>
            </div>
            <!-- 链条 -->
            <ipt-chain></ipt-chain>
            <div class="form-group">
    ...
    methods: {
      ...
      generate() {
        ...
        self.$validator.validateAll().then((result) => {
          if (result) {
            Api.EmergencyCityHandle.compound(this.queryId, this.editedParams).then((data) => {
