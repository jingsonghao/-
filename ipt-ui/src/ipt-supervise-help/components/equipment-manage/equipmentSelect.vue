<template>
  <ipt-modal>
    <span slot="modalTitle">发放设备选择</span>
      ...
      <div class="table-container">
        ...
        <div class="col-xs-12 table-box">
          <table class="table table-condensed">
            ...
            <tbody>
            <tr v-for="option in equipmentSelectTableData">
    ...
    methods: {
      ...
      checkAllBtn: function () {
        ...
        if ($("#checkAllBtn").is(":checked")) {
          ...
          for (let i = 0; i < _this.equipmentSelectTableData.length; i++) {
            _this.equipmentSelectList.push(JSON.stringify(_this.equipmentSelectTableData[i]))
          }
        } else {
          _this.equipmentSelectList = []
        }
      ...
      search: function () {
        this.getEquipmentSelectTableData(this.equipmentSelectTableParams)
      },
      saveSelect: function () {
        let _this = this
        let equipmentNames = ""
        ...
        _this.getEquipmentSelectListData({equipmentCodes: equipmentCodes, equipmentNames: equipmentNames})
        _this.cancel()
      },
      reset: function () {
      ...
      cancel: function () {
        $('#equipmentSelect div.modal-header > button[aria-label="Close"]').trigger('click')
      ...
      ...mapActions({
        ...
        getEquipmentSelectListData: 'getEquipmentSelectListData'
      })
    },
    computed: mapGetters({
      equipmentSelectTableData: 'equipmentSelectTableData'
    })
  }
</script>
