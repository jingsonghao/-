/**
 * @描述: 大数据审核监测 --> 节点数据监测 --> 批发市场
 * @作者: Guo Ze Qiang
 * @日期: 2017/11/23
 * @时间: 13:12
 */
export default {
  getWholesaleMarketTableData(params, cb) { //批发市场（配送中心）基本信息
  ...
  getWholesaleEnterOperatorInfoTableData(params, cb) { //批发市场进场经营者（批发商、零售商）基本信息
    return new Promise(function(resolve) {
      resolve({})
    })
  },
  getWholesaleMeatEnterInfoTableData(params, cb) { //批发市场肉品进场信息
    return new Promise(function(resolve) {
      resolve({})
    })
  },
  getWholesaleMeatDetectionInfoTableData(params, cb) { //批发市场肉品检测信息
    return new Promise(function(resolve) {
      resolve({})
    })
  },
  getWholesaleMeatTradingInfoTableData(params, cb) { //批发市场肉品交易信息
    return new Promise(function(resolve) {
      resolve({})
    })
  }
