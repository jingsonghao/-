/**
 * @描述: 大数据审核监测 --> 节点数据监测 --> 零售市场
 * @作者: Guo Ze Qiang
 * @日期: 2017/11/23
 * @时间: 13:12
 */
export default {
  getRetailMarketInfoTableData(params, cb) { //零售市场基本信息
  ...
  getRetailMarketEnterOperatorInfoTableData(params, cb) {  //零售市场进场经营者（零售商）基本信息
    return new Promise(function(resolve) {
      resolve({})
    })
  },
  getRetailMarketMeatEnterInfoTableData(params, cb) {  //零售市场肉品进场信息
    return new Promise(function(resolve) {
      resolve({})
    })
  },
  getRetailMarketMeatSalesSummaryTableData(params, cb) { //零售市场肉品销售汇总信息
    return new Promise(function(resolve) {
      resolve({})
    })
  }
