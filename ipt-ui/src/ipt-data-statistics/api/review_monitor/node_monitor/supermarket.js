/**
 * @描述: 大数据审核监测 --> 节点数据监测 --> 超市
 * @作者: Guo Ze Qiang
 * @日期: 2017/11/23
 * @时间: 13:12
 */
export default {
  getSupermarketInfoTableData(params, cb) { //超市基本信息
  ...
  getSupermarketMeatSupplierInfoTableData(params, cb) {  //超市肉品供应商基本信息
    return new Promise(function(resolve) {
      resolve({})
    })
  },
  getSupermarketMeatEnterInfoTableData(params, cb) { //超市肉品进场信息
    return new Promise(function(resolve) {
      resolve({})
    })
  }
